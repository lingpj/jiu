...
class ServerAPI{
	...
	public function sendSMSTemplate($templateid,$mobiles = array(),$params=''){
		...
		return $this->postDataFsockopen($url,$data);
	...
	public function sendText($templateid,$mobiles = array(),$params = []){
		$url = 'https://api.netease.im/sms/sendtemplate.action';
		$data = array(
			'templateid' => $templateid,
			'mobiles'    => $this->array2string($mobiles),
			'params'     => $this->array2string($params)
		);
